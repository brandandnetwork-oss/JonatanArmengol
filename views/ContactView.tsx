    ...
    <div className="max-w-[1200px] mx-auto px-6 py-10 lg:py-20">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        <div className="lg:col-span-5 flex flex-col gap-8">
          <div>
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">Representación & Network</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="#" className="flex items-center justify-between bg-white border border-[#f4f2f0] rounded-xl px-4 py-4 hover:border-primary transition-colors group">
              <div className="flex items-center gap-4">
                <div className="text-primary bg-primary/10 p-3 rounded-lg material-symbols-outlined">chat</div>
                <div>
                  <p className="text-dark-accent font-bold">WhatsApp Profesional</p>
                  <p className="text-[#897261] text-sm">+34 625 034 042</p>
                </div>
              </div>
              <span className="material-symbols-outlined group-hover:text-primary">arrow_forward</span>
            </a>
          </div>
            ...
            <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" className="h-14 rounded-lg border-2 border-gray-100 px-4 focus:border-primary focus:ring-0 transition-colors" placeholder="Ej. Juan Pérez" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-bold">Empresa</label>
                  <input type="text" className="h-14 rounded-lg border-2 border-gray-100 px-4 focus:border-primary focus:ring-0 transition-colors" placeholder="Nombre de tu organización" />
                </div>
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold">Asunto del Interés</label>
                <select className="h-14 rounded-lg border-2 border-gray-100 px-4 focus:border-primary focus:ring-0 transition-colors">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea rows={5} className="rounded-lg border-2 border-gray-100 p-4 focus:border-primary focus:ring-0 transition-colors" placeholder="Cuéntanos más..."></textarea>
              </div>
              <button className="h-16 rounded-xl bg-primary text-white text-lg font-black hover:bg-[#d46111] transition-all transform hover:scale-[1.01] active:scale-95 shadow-lg shadow-primary/20">
                ENVIAR MENSAJE
              </button>
            </form>
          </div>
