    ...
    <div className="w-full">
      ...
      <section className="max-w-[1280px] mx-auto px-6 py-12 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          <span className="bg-primary/10 text-primary px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-wider">Accesibilidad de Alto Impacto</span>
          <h1 className="text-4xl md:text-6xl font-black leading-tight tracking-tighter text-dark-accent">
            La accesibilidad no es un checklist, es una <span className="text-primary">ventaja competitiva</span>.
          </h1>
          ...
          <div className="flex gap-4">
            <button className="bg-primary text-white px-8 py-4 rounded-xl text-lg font-bold shadow-lg flex items-center gap-2 hover:brightness-110 active:scale-95 transition-all">
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="absolute bottom-6 left-6 bg-white p-6 rounded-xl shadow-xl hidden md:block border border-gray-100">
            <p className="text-3xl font-black text-primary">+15 Años</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              ...
              <div key={i} className="flex flex-col items-center gap-6">
                <div className={`size-20 rounded-full border-4 flex items-center justify-center font-black text-2xl ${i === 1 ? 'bg-primary border-white text-white' : 'bg-white border-primary text-primary shadow-xl'}`}>
                  {step.num}
                </div>
      ...
      <section className="max-w-[1280px] mx-auto px-6 pb-24">
        <div className="bg-primary rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden">
          ...
          <button className="bg-white text-primary px-10 py-5 rounded-2xl text-xl font-extrabold shadow-2xl hover:-translate-y-1 transition-all flex items-center gap-3 mx-auto">
