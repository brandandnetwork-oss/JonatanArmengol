      ...
      <section className="p-4 md:p-10">
        ...
        >
          <div className="flex flex-col gap-3 text-left max-w-2xl">
            <span className="bg-primary px-3 py-1 rounded text-white text-xs font-bold uppercase tracking-widest w-fit">Radio Program</span>
          ...
          <div className="flex gap-4">
            <button className="flex items-center justify-center rounded-lg h-12 px-6 bg-primary text-white text-base font-bold transition-transform hover:scale-105">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 bg-white p-6 rounded-2xl shadow-xl border border-[#f4f2f0]">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="relative flex items-center justify-center bg-dark-accent aspect-video rounded-xl overflow-hidden group">
              ...
              <button className="absolute z-10 size-20 bg-primary text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex gap-3">
                  <span className="bg-primary/10 text-primary p-2 rounded-lg material-symbols-outlined">{item.icon}</span>
                  <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="group bg-white rounded-xl overflow-hidden shadow-sm border border-[#f4f2f0] hover:shadow-xl transition-all">
              ...
              <div className="p-5">
                <span className="text-primary text-xs font-bold uppercase mb-2 block">{item.cat}</span>
