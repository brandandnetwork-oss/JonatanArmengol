    ...
    <div className="max-w-[1200px] mx-auto px-4 md:px-10 pb-20">
      <section className="py-10 md:py-20 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          <span className="text-primary font-bold tracking-widest uppercase text-sm">Media Kit 2024</span>
          <h1 className="text-4xl md:text-6xl font-black leading-tight text-dark-accent">
            Influencer & <br/><span className="text-primary">Creador de Contenido</span>
          </h1>
          ...
          <div className="flex gap-4 pt-4">
            <button className="bg-primary text-white px-8 py-4 rounded-lg font-bold shadow-lg hover:translate-y-[-2px] transition-all">Ver Métricas</button>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-8 bg-white rounded-xl border border-gray-100 shadow-sm mb-16">
        {[
          ...
          <div key={i} className="p-6 bg-[#f8f7f6] rounded-lg border border-transparent hover:border-primary transition-colors">
      ...
      <section className="bg-primary rounded-2xl p-10 md:p-16 text-white flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <button className="bg-white text-primary px-10 py-5 rounded-xl font-black text-lg shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center gap-3">
